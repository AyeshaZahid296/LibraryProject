...
namespace LibraryManagementSystem {
	...
	/// <summary>
	/// Summary for MembersForm
	/// </summary>
	public ref class MembersForm : public System::Windows::Forms::Form
	{
	public:
		MembersForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(23, 112);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(23, 167);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(23, 216);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(23, 268);
			...
			this->label5->Click += gcnew System::EventHandler(this, &MembersForm::label5_Click);
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(199, 32);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(93, 24);
			this->label6->TabIndex = 5;
			this->label6->Text = L"Members";
			// 
			// label7
			// 
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(280, 366);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(0, 19);
			this->label7->TabIndex = 6;
			this->label7->Click += gcnew System::EventHandler(this, &MembersForm::label7_Click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(213, 376);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(104, 40);
			this->button1->TabIndex = 7;
			this->button1->Text = L"Submit";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &MembersForm::button1_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(168, 113);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(168, 167);
			...
			this->textBox3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox3->Location = System::Drawing::Point(168, 216);
			...
			this->textBox4->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox4->Location = System::Drawing::Point(168, 268);
			...
			this->textBox5->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox5->Location = System::Drawing::Point(168, 315);
			...
			this->ClientSize = System::Drawing::Size(490, 453);
			...
			this->Name = L"MembersForm";
			this->Text = L"MembersForm";
			this->Load += gcnew System::EventHandler(this, &MembersForm::MembersForm_Load);
...
private: System::Void MembersForm_Load(System::Object^ sender, System::EventArgs^ e) {
}
